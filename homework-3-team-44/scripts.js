...
//making a function that gets random color everytime page is refreshed
...
function DrawSpiral(context) {
    ...
    for (let counter = 1; counter < 800; counter ++) {
        //applying our random color function
...
// I added this for homepage button

document.addEventListener('DOMContentLoaded', function () {

    const button = document.getElementById('learnAboutOurTeam');
